    ...
    public void doRentalRate(Integer number) {
        ...
        if(number == 1) {
            ...
            for(RentalRates rentalRate: rentalRates) {
                System.out.println("Rental Rate ID: " + rentalRate.getRentalRateId() +"Rental Rate Name: " + rentalRate.getName() + "Category: " + rentalRate.getCategory().getCategoryName() + " Rate per Day: " + rentalRate.getRatePerDay());
